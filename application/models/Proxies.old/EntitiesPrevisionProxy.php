 ...
 */
class EntitiesPrevisionProxy extends \Entities\Prevision implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addDescuentosPrevision($descuentosPrevision);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'nombre', 'contratos', 'descuentosPrevision');
    }
