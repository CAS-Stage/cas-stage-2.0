 ...
 */
class EntitiesParametroExternoProxy extends \Entities\ParametroExterno implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'codigo', 'fecha_vigencia', 'valor');
    }
