...
<html>
    ...
    <body>
        ...
        <section>
            <h1>Actualizar Tipos de Contrato</h1>
            <p><strong>Error:</strong> el tipo de contrato no ha podido actualizarse, ya que para la fecha de vigencia y cargo indicados ya existe otro valor definido.</p>
